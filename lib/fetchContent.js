...
function tmeIdOfV2Annnotation( v2Annotation ){
...
function calcV1OntologyFromTmeId( tmeId ){
...
function searchByTmeId( params, tmeId ){
	const ontology = calcV1OntologyFromTmeId( tmeId );
	if (! ontology ) {
		return Promise.resolve(null);
	}
	return tmeIdOfV2Annnotation(v2Annotation)
	// .then()
	;
}
